...
-- theme.tasklist_bg_focus = "#990000"
theme.tasklist_fg_normal = "#818b91"

theme.taglist_bg_focus = "#818b91"
theme.taglist_bg_empty = "#121212"
theme.taglist_bg_occupied = "#373c4e"
theme.taglist_bg_urgent = "#ffffff"

theme.titlebar_bg_normal = "#373c4e"
theme.titlebar_bg_focus = "#990000"
